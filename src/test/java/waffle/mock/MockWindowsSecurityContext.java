...
public class MockWindowsSecurityContext implements IWindowsSecurityContext {
    ...
    public MockWindowsSecurityContext(final String username) {
        ...
        groups.add("Everyone");
        groups.add("ceo");
        this.identity = new MockWindowsIdentity("hnelson", groups);
    }
    ...
    @Override
    public void initialize(final CtxtHandle continueCtx, final SecBufferDesc continueToken, final String targetPrincipalName) {
        // Do Nothing
    }
}
