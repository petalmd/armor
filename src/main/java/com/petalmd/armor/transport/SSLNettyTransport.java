...
public class SSLNettyTransport extends ArmorNettyTransport {
    ...
    protected static class SSLServerChannelPipelineFactory extends ServerChannelPipelineFactory {
        ...
        public SSLServerChannelPipelineFactory(final NettyTransport nettyTransport, final String name, final Settings sslsettings,
            ...
            keystoreType = essettings.get(ConfigConstants.ARMOR_SSL_TRANSPORT_NODE_KEYSTORE_TYPE, "JKS");
            keystoreFilePath = essettings.get(ConfigConstants.ARMOR_SSL_TRANSPORT_NODE_KEYSTORE_FILEPATH, null);
            keystorePassword = essettings.get(ConfigConstants.ARMOR_SSL_TRANSPORT_NODE_KEYSTORE_PASSWORD, "changeit");
            enforceClientAuth = essettings.getAsBoolean(ConfigConstants.ARMOR_SSL_TRANSPORT_NODE_ENFORCE_CLIENTAUTH, true);
            truststoreType = essettings.get(ConfigConstants.ARMOR_SSL_TRANSPORT_NODE_TRUSTSTORE_TYPE, "JKS");
            truststoreFilePath = essettings.get(ConfigConstants.ARMOR_SSL_TRANSPORT_NODE_TRUSTSTORE_FILEPATH, null);
            truststorePassword = essettings.get(ConfigConstants.ARMOR_SSL_TRANSPORT_NODE_TRUSTSTORE_PASSWORD, "changeit");
        }
    ...
    protected static class SSLClientChannelPipelineFactory extends ClientChannelPipelineFactory {
        ...
        public SSLClientChannelPipelineFactory(final NettyTransport nettyTransport, final Settings settings) {
            ...
            hostnameVerificationEnabled = settings.getAsBoolean(
                    ConfigConstants.ARMOR_SSL_TRANSPORT_NODE_ENCFORCE_HOSTNAME_VERIFICATION, true);
            hostnameVerificationResovleHostName = settings.getAsBoolean(
                    ConfigConstants.ARMOR_SSL_TRANSPORT_NODE_ENCFORCE_HOSTNAME_VERIFICATION_RESOLVE_HOST_NAME, true);
        }
